#' Create a homework template for autogradeR
#'
...
assignment.template <- function(path = "."){
  ...
  file.copy(system.file("extdata", "sample_dataset.csv", package = "autogradeR"), file.path(subDir, "data/sample_dataset.csv"), overwrite = TRUE)
  
  #Generate answer template and readme files
  file.copy(system.file("extdata", "answers_template.Rmd", package = "autogradeR"), file.path(subDir, "tests/0_answers_template_original.Rmd"), overwrite = TRUE)
  file.copy(system.file("extdata", "answers_template.Rmd", package = "autogradeR"), file.path(subDir, "tests/1_answers_template.Rmd"), overwrite = TRUE)
  file.copy(system.file("extdata", "README.Rmd", package = "autogradeR"), file.path(subDir, "README.Rmd"), overwrite = TRUE)
